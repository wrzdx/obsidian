...
| And many others                              |                                            |                              |                    |
## Key DNS Services
| Key DNS Service                                          | Description                                                                                                                                                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Translation of host names to IP addresses and vice versa | • To obtain the IP addresses for given web pages and vice versa; <br>• To examine the authentity of the Internet resources <br>• Example: “www.innopolis.university” IP address: 213.159.212.4                                                                                                                                                                                                                                 |
| Host aliasing                                            | • A host name might correspond to one or several aliases; <br>• DNS supports CNAME records type to support such a functionality <br>• Example: “www.enterprise.com” corresponds to “relay1.west-coast.enterprise.com”                                                                                                                                                                                                          |
| Mail server aliasing                                     | • Translation of a mnemonic mail server alias to the canonical host name; <br>• Example: bob@hotmail.com corresponds to relay1.west-coast.hotmail.com                                                                                                                                                                                                                                                                          |
| Load distribution on Web servers                         | • A busy web page (e.g. yandex.ru) is replicated over multiple physical servers with different IP addresses; <br>• A set of IP addresses is associated to the same canonical hostname; <br>• When sending the IP records to clients, DNS servers reorders/rotates the IP addresses, to balance the load on physical servers hosting that web page; <br>• Client typically connects to the first IP address provided by the DNS |
