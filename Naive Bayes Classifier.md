...
- But every $p(x_{i})$ is between 0 and 1 the result will be very small number and we could lose precision, so we calculate log of product instead of just product, and compare them 
