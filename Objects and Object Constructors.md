...
- `this` – ссылка на текущий объект, создается при создании объекта через конструктор и присваивается переменной. `this` есть везде и если она не изменена или передана, то равна `window`.
